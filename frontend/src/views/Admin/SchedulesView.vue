...
.sub-date.highlight { color: #15803d; font-weight: 500; }
.due-badge { font-weight: 700; color: #15803d; }
...
.badge-scheduled { background: #ccfbf1; color: #0f766e; } .badge-scheduled .badge-dot { background: #0d9488; }
...
.btn-primary { display: inline-flex; align-items: center; gap: 0.5rem; background: #16a34a; color: #ffffff; border: none; padding: 0 1.25rem; height: 42px; border-radius: 10px; font-weight: 600; font-size: 0.875rem; cursor: pointer; transition: background-color 0.2s; }
...
.form-group input, .custom-select { height: 40px; padding: 0 0.875rem; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 0.875rem; color: #0f172a; outline: none; transition: border-color 0.2s, box-shadow 0.2s; }
